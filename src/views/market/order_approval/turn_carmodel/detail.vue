          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="变更类型" prop="type">
                ...
                <p class="td_text_red">无需收费的，请选择【非正常转车型】</p>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="收款单据号" prop="receipt">
                <el-select
                  ...
                  :disabled="formData.type === 4 || type === 1"
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-col :span="6">
              <el-form-item label="新车型" prop="newModel">
                <el-select
                  class="w_200"
                  v-model="formData.newModel"
                  :disabled="formData.type === 3 || type === 1"
                  placeholder="请选择"
                >
                  <el-option
                    v-for="item in [{ label: 'C1' }, { label: 'C2' }]"
                    :key="item.label"
                    :label="item.label"
                    :value="item.label"
                  >
...
export default class MarketOrderApprovalTurnCarmodelDetail extends Index {}
</script>

  ...
  <div class="page">
    ...
    >
      <div style="display: flex; align-items: center">
        审批状态：<el-link :underline="false" type="primary">{{
          auditStatus | auditStatusFilter
        }}</el-link>
        <span style="margin-left: 20px;">
          申请单号：<el-link :underline="false" type="primary">{{ formData.id }}</el-link>
        </span>
      </div>
      <div>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="变更类型" prop="type">
                ...
                <p class="td_text_red">无需收费的，请选择【非正常转校】</p>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="收款单据号" prop="receipt">
                <el-select
                  ...
                  :disabled="formData.type === 6 || type === 1"
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-col :span="6">
              <el-form-item label="应收金额" prop="amount">
                <el-input
                  ...
                  :disabled="formData.type === 5 || type === 1"
                  placeholder="请输入应收金额"
                ></el-input>
              </el-form-item>
            </el-col>
...
export default class MarketOrderApprovalTurnClasstypeDetail extends Index {}
</script>

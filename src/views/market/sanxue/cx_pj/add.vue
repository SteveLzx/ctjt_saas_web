      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="赠送学时：" prop="presentPeriod">
            <el-input v-model="formData.presentPeriod" class="w_260" readonly></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="散学车型：" prop="carModel">
            <el-select v-model="formData.carModel" placeholder="请选择散学车型" class="w_260">
              <el-option
...
export default class MarketSanXueCxToPjMgAdd extends Index {}
</script>

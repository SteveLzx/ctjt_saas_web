...
export default class EducationalCoachMgCoachApply extends mixins(ctjtPaginationMixins, ctjttablefieldMixins) {
  ...
  private jumpDetail(id?: string) {
    this.$router.push({ path: '/educational/coach_mg/coach_apply/detail', query: { id } });
  }
  ...
  async mounted() {
    ...
    this.tableLabelType = 'COACH_MG_COACH_APPLY_LABEL';
    this.queryList();
    this.initSetTableLabel();
    this.initSearch();
  }

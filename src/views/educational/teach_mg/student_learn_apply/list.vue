      ...
      <CtjtCard :prop-data="{ title: '申请状态-已完成' }">
        <template slot='content'>
          <el-form label-width="100px">
            <el-form-item label="申请类型:">恢复学车</el-form-item>
            ...
            <el-divider content-position="left">该学员暂停学车相关记录</el-divider>
...
export default class EducationalTeachMgStudentLearnApply extends Index {}
</script>

...
export default class EducationalTeachMgStudentLearnApply extends mixins(ctjtPaginationMixins, ctjttablefieldMixins) {
  // 弹窗名称
  private dialogName = '';
  ...
  async mounted() {
    ...
    this.tableLabelType = 'TEACH_MG_STUDENT_LEARN_APPLY_LABEL';
    this.initSetTableLabel();
    // 先默认请求驾校

...
@Component
export default class FinanceCurrentGraduationFixed extends Vue {
  @Action('finance/queryCurrentGraduateFixedList') private queryCurrentGraduateFixedList!: (data: any) => ParamsType;
  ...
  */
  ...
  jumpDetail(step: number) {
    ...
    this.$router.push({
      path: '/finance/confirm_income_by_stage/current_graduation_fixed/detail',
  ...
  async queryList() {
    ...
    try {
      const body = await this.queryCurrentGraduateFixedList(sendData);

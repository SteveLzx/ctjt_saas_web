...
@Component
export default class FinanceGraduationCorrectionFixed extends Vue {
  @Action('finance/queryGraduationCorrectionFixedList') private queryGraduationCorrectionFixedList!: (data: any) => ParamsType;
  ...
  */
  ...
  jumpDetail(step: number) {
    ...
    this.$router.push({
      path: '/finance/confirm_income_by_stage/graduation_correction_fixed/detail',
  ...
  async queryList() {
    ...
    try {
      const body = await this.queryGraduationCorrectionFixedList(sendData);

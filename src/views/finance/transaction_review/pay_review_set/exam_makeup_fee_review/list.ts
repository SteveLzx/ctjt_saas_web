...
const name = '补考费复核';
@Component
export default class FinancepayReviewSetExamMakeupFeeReview extends mixins(ctjtPaginationMixins, ctjttablefieldMixins, financePayReviewSeachTableMixins) {
 ...
 */
  ...
  */
  ...
  async checkTab(val: number) {
    ...
    const _typeDta: ParamsType = {
      1: 'EXAM_MAKEUP_FEE_REVIEW_OTHER_LIST_LABEL',
      2: 'EXAM_MAKEUP_FEE_REVIEW_SELF_LIST_LABEL',
    };
  ...
  */
  ...
  async mounted() {
    ...
    this.queryList();
    this.tableLabelType = 'EXAM_MAKEUP_FEE_REVIEW_OTHER_LIST_LABEL';
    this.initSetTableLabel();
  }
